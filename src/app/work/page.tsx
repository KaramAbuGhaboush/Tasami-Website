...
export default function Work() {
  ...
  const projectsData = t('work.projects.items');
  const projects = Array.isArray(projectsData) ? projectsData : [];
  const categoriesData = t('work.categories');
  const categories = Array.isArray(categoriesData) ? categoriesData : [];

  // Testimonials data
  const testimonialsData = t('work.testimonials.items');
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
              {(() => {
                const indicators = t('work.hero.indicators');
                if (Array.isArray(indicators)) {
                  return indicators.map((indicator: any, index: number) => (
                    <div key={index} className="text-center group">
                      <div className="text-3xl md:text-4xl font-bold text-[#6812F7] mb-2 group-hover:scale-110 transition-transform duration-300">{indicator.value}</div>
                  ...
                  <div className="p-8 flex flex-col flex-grow">
                    ...
                    <div className="mb-6">
                      <div className="flex flex-wrap gap-2">
                        {Array.isArray(project.results) && project.results.slice(0, 2).map((result: string, resultIndex: number) => (
                    ...
                    <div className="flex items-center text-[#667eea] font-semibold group-hover:text-[#764ba2] transition-colors duration-300 mt-auto">
                      <span>{t('work.projects.viewProject')}</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              {t('work.metrics.title')}
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              {t('work.metrics.description')}
            </p>
          </div>

          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {(() => {
              const metrics = t('work.metrics.items');
                ...
                return metrics.map((metric: any, index: number) => (
                  <div key={index} className="group text-center">
                    <div className="bg-white p-10 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                      ...
                      <div className="text-gray-600 font-medium text-lg">{metric.label}</div>
                    </div>
                  </div>
                ));
              }
      ...
      <section className="py-24 bg-white overflow-visible">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              {t('work.testimonials.description')}
            </p>
          </div>
                    ...
                    <div className="max-w-4xl mx-auto">
                      <div className="bg-gradient-to-br from-white to-gray-50 p-8 md:p-12 rounded-3xl shadow-lg border border-gray-100 relative overflow-visible text-center testimonial-card min-h-[400px] flex flex-col justify-center">
                        <div className="text-center py-8 text-gray-500">
                          {t('common.loading') || 'Loading testimonials...'}
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-3 gap-8 mb-12 max-w-2xl mx-auto">
              <div className="text-center">
                ...
                <div className="text-white/80 text-sm">{t('work.cta.stats.projects')}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-1">98%</div>
                <div className="text-white/80 text-sm">{t('work.cta.stats.onTime')}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-1">4.9/5</div>
                <div className="text-white/80 text-sm">{t('work.cta.stats.rating')}</div>
              </div>
            </div>
