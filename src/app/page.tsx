          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
            <div className="space-y-8">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <span className="text-sm text-[#6812F7] font-semibold">01</span>
                  <h3 className="text-4xl font-bold text-gray-900">AI Solutions</h3>
                </div>
              </div>
              <p className="text-xl text-gray-600 leading-relaxed">
                Machine learning, natural language processing, and intelligent automation to revolutionize your business processes and drive unprecedented efficiency.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
            ...
            <div className="space-y-8 lg:order-2">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <span className="text-sm text-[#9253F0] font-semibold">02</span>
                  <h3 className="text-4xl font-bold text-gray-900">Automation</h3>
                </div>
              </div>
              <p className="text-xl text-gray-600 leading-relaxed">
                Streamline workflows and eliminate manual tasks with intelligent automation solutions tailored to your specific business needs and processes.
              </p>
              <ul className="space-y-3">
                <li className="flex items-center space-x-3">
                ...
                <li className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-[#9253F0] rounded-full"></div>
                  <span className="text-gray-700">Smart Integrations</span>
                </li>
              </ul>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
            <div className="space-y-8">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <span className="text-sm text-[#DFC7FE] font-semibold">03</span>
                  <h3 className="text-4xl font-bold text-gray-900">Design & UX/UI</h3>
                </div>
              </div>
              <p className="text-xl text-gray-600 leading-relaxed">
                Beautiful, intuitive interfaces that engage users and drive conversions through exceptional design and user experience optimization.
              </p>
              <ul className="space-y-3">
                <li className="flex items-center space-x-3">
                ...
                <li className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-[#DFC7FE] rounded-full"></div>
                  <span className="text-gray-700">User Experience Research</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-[#DFC7FE] rounded-full"></div>
                  <span className="text-gray-700">Prototyping & Testing</span>
                </li>
              </ul>
              <Link href="/services" className="inline-flex items-center text-[#DFC7FE] font-semibold hover:text-[#c084fc] transition-colors">
                Learn More
                  <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
            ...
            <div className="space-y-8 lg:order-2">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <span className="text-sm text-[#6812F7] font-semibold">04</span>
                  <h3 className="text-4xl font-bold text-gray-900">Marketing Solutions</h3>
                </div>
              </div>
              <p className="text-xl text-gray-600 leading-relaxed">
                Data-driven marketing strategies and campaigns that reach the right audience and deliver measurable results for your business growth.
              </p>
              <ul className="space-y-3">
                <li className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-[#6812F7] rounded-full"></div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
            <div className="space-y-8">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <span className="text-sm text-[#9253F0] font-semibold">05</span>
                  <h3 className="text-4xl font-bold text-gray-900">MVP Development</h3>
                </div>
              </div>
              <p className="text-xl text-gray-600 leading-relaxed">
                Rapid development of minimum viable products to validate your business ideas quickly and cost-effectively with market-ready solutions.
              </p>
              <ul className="space-y-3">
                <li className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-[#9253F0] rounded-full"></div>
                  <span className="text-gray-700">Rapid Prototyping</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-[#9253F0] rounded-full"></div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8 lg:order-2">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <span className="text-sm text-[#DFC7FE] font-semibold">06</span>
                  <h3 className="text-4xl font-bold text-gray-900">Data Analysis</h3>
                </div>
              </div>
              <p className="text-xl text-gray-600 leading-relaxed">
                Transform raw data into actionable insights with advanced analytics, machine learning, and business intelligence solutions.
              </p>
              <ul className="space-y-3">
                <li className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-[#DFC7FE] rounded-full"></div>
