        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600/10 to-purple-600/10 rounded-full text-blue-600 text-sm font-medium mb-8 border border-blue-200">
              <span className="w-2 h-2 bg-blue-600 rounded-full mr-4 rtl:mr-0 rtl:ml-4 animate-pulse"></span>
              {t('badgeText')}
            </div>
                    ...
                    return (
                      <div key={index} className="flex items-center justify-between p-3 sm:p-4 bg-white/40 backdrop-blur-sm rounded-xl border border-white/20 hover:bg-gradient-to-r hover:from-[#6812F7]/10 hover:to-[#9253F0]/10 hover:border-[#6812F7]/20 transition-all duration-300">
                        <div className="flex items-center min-w-0 flex-1">
                          <div className="text-xl sm:text-2xl mr-2 sm:mr-3 rtl:mr-0 rtl:ml-2 rtl:sm:ml-3 flex-shrink-0">
                            {info.icon === 'mail' && <Mail className="w-6 h-6 text-[#6812F7]" />}
                            {info.icon === 'whatsapp' && (
              ...
              <div className="relative z-10">
                <div className="text-center mb-8">
                  <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-[#6812F7]/10 to-[#9253F0]/10 rounded-full text-[#6812F7] text-sm font-medium mb-4">
                    <span className="w-2 h-2 bg-[#6812F7] rounded-full mr-3 rtl:mr-0 rtl:ml-3 animate-pulse"></span>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-2 gap-6">
                    <div className="group">
                      ...
                      <input
                        ...
                        required
                        className="w-full py-3 px-0 border-0 border-b-2 border-gray-300 focus:border-[#6812F7] focus:outline-none transition-all duration-300 bg-transparent text-gray-900 placeholder-gray-500 rtl:text-right"
                  ...
                  <p className="text-xs text-gray-500 mt-1">{t('form.helperText.contactRequired')}</p>
                    ...
                    <div className="group">
                      ...
                      <div className="relative">
                        <select
                          ...
                          onChange={handleChange}
                          required
                          className="w-full py-3 px-0 border-0 border-b-2 border-gray-300 focus:border-[#6812F7] focus:outline-none transition-all duration-300 appearance-none bg-transparent text-gray-900 pr-8 rtl:text-right rtl:pl-8 rtl:pr-0"
                        >
                        ...
                        <div className="absolute inset-y-0 right-0 rtl:right-auto rtl:left-0 flex items-center pointer-events-none">
                  ...
                  <div className="group">
                    ...
                    <textarea
                      ...
                      required
                      rows={4}
                      className="w-full py-3 px-0 border-0 border-b-2 border-gray-300 focus:border-[#6812F7] focus:outline-none transition-all duration-300 bg-transparent text-gray-900 placeholder-gray-500 resize-none rtl:text-right"
